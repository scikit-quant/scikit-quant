...
private:
    ...
    static BBOutputTypeList _bbOutputType; ///< Corresponds to parameter BB_OUTPUT_TYPE used for this cach
...
public:
    ...
    size_t find(const Point & x,
                EvalPoint &evalPoint) const override;
